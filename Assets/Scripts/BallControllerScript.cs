...
public class BallControllerScript : MonoBehaviour {
	...
	private void OnTriggerEnter(Collider other)
	{
		...
		{
			BatControllerScript.instance.isBallInHittingRange = true;
			Debug.Log("Enter HitZone");
		}
	}
	...
	private void OnTriggerExit(Collider other)
	{
		if (other.tag == "HitZone")
		{
			BatControllerScript.instance.isBallInHittingRange = false;
			Debug.Log("Exit HitZone");
		}
	}
